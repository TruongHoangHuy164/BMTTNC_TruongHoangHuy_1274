...
context.load_cert_chain(
    certfile="H:/BMTTNC_TruongHoangHuy_1274/LAB-05/ssl/certificates/server-cert.crt",
    keyfile="H:/BMTTNC_TruongHoangHuy_1274/LAB-05/ssl/certificates/server-key.key"
)
